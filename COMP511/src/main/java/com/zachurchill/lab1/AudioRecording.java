...
/**
 * AudioRecording implements the MediaType interface for audio-related mediums.
 * 
 * @author Zach Churchill <church58@email.franklin.edu>
 * @version 2024-03-19
 */
public class AudioRecording implements MediaItem
{
    // instance variables
    ...
    private final Dollar LATE_FEE_CHARGE = new Dollar(0, 50);
